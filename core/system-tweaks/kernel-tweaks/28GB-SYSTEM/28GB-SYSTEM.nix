...

{
  boot.kernel.sysctl = {
    ...
    "vm.dirty_background_bytes" = 434217728;    # 128 MB + 300 MB = 428 MB (rounded to 434217728)
    "vm.dirty_bytes" = 702653184;               # 384 MB + 300 MB = 684 MB (rounded to 702653184)
    ...
    "vm.vfs_cache_pressure" = 95;               # Adjust vfs_cache_pressure (0-1000) to manage memory used for caching filesystem objects. Adjusted for 28GB RAM.
