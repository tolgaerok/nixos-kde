...
# Kernel tweaks
{
  boot.kernel.sysctl = {
    ...
    "vm.vfs_cache_pressure" = 70;               # Adjust vfs_cache_pressure (0-1000), how the kernel reclaims memory used for caching filesystem objects
    ...
    # "net.core.wmem_default" = 131072;           # Default socket send buffer size, improve network performance & applications that use sockets
