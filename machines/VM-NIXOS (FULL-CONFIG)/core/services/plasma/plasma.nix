 
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-a886da9a-fb7e-4588-b5ab-86928caef2e8" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."kuick-copy"."Paths[$e]" = "smb://tolga@192.168.0.11/Documents,/run/media/tolga/20C1-81FF,/run/media/tolga/Ventoy/WINDOWS,$HOME/Developments/,$HOME/Development/NixOS/,$HOME/Documents/";
      "dolphinrc"."kuick-move"."Paths[$e]" = "$HOME/Desktop/,$HOME/Developments/MyGitHub/,$HOME/Desktop/nixos github master/NixOS-tolga-main/SCRIPTS/";
      "kactivitymanagerdrc"."activities"."a886da9a-fb7e-4588-b5ab-86928caef2e8" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "a886da9a-fb7e-4588-b5ab-86928caef2e8";
      "kcminputrc"."Keyboard"."NumLock" = 0;
      "kcminputrc"."Keyboard"."RepeatDelay" = 406;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "932,598";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 223;
      "kdeglobals"."KFileDialog Settings"."View Style" = "Simple";
      "kdeglobals"."PreviewSettings"."MaximumRemoteSize" = 8388608;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{6bdbe264-214e-4fa8-b5ab-17c7cf5e5933}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{c4077428-be8c-44f8-b328-8d79f059140b}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{9e434371-cc88-413e-a9b3-bb4ef8f30d54}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{91f33331-a2a9-474b-bc04-48e17cbc2600}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{6572d3b6-a952-4fb7-84e1-329269b5389c}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{4b3702ae-7879-4638-a49f-b35f1db211b8}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{81a8e421-1775-4780-98ab-96cfc8bd7760}";
      ...
      "kservicemenurc"."Show"."EditInKate" = true;
      "kservicemenurc"."Show"."OpenAsRootKDE5" = true;
      ...
      "kservicemenurc"."Show"."rename" = true;
      ...
      "kwinrc"."Desktops"."Id_1" = "30202d8c-a827-41e0-ad87-fa757cb85983";
      ...
      "kwinrc"."Tiling.13cab51d-7953-5eab-be7b-a1dae3d94ddc"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.3776013f-3f14-57ca-8a5c-d222661bf9c2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.54b9fdd9-2ffe-5088-86e2-e6539803ff44"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.90b1a208-55dc-5f60-9182-bad1550344b6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.c2e27ee3-8fc7-5a31-8ddd-e259c4b61260"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.dda6a2f8-2a93-5bad-a48c-1e8eee12778f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_AU.UTF-8";
      "plasmarc"."Theme"."name" = "Layan";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/tolga/Pictures/Wallpapers/wp12329531-nixos-wallpapers.png,/home/tolga/Pictures/Wallpapers/hills_and_mountains_day.png,/home/tolga/Pictures/Wallpapers/sea_ship_day.png,/home/tolga/Pictures/Wallpapers/philippines_day.png,/home/tolga/Pictures/Wallpapers/valley_day.png,/home/tolga/Pictures/Wallpapers/sea_ship_sunset.png,/home/tolga/Pictures/Wallpapers/japan_river.jpg,/home/tolga/Pictures/nix logos/nix.png,/home/tolga/Desktop/Screenshot_20230808_120231.png,/home/tolga/Desktop/batman.png,/home/tolga/Desktop/nix.png";
